      ...
      <header className="rounded-3xl border border-white/70 bg-white/85 p-8 shadow-glow">
        ...
        <section aria-labelledby="overview" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          ...
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>Millions of people around the world lack access to basic technology. device donations works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
        ...
        <section aria-labelledby="how-donations-work" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          ...
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>Devices are collected, evaluated, refurbished when possible, and matched with partners focused on digital access. device donations works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
        ...
        <section aria-labelledby="eligible-devices" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          ...
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>Smartphones, tablets, laptops, and accessories are among the most requested items. device donations works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
        ...
        <section aria-labelledby="data-security" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          ...
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>TechJoy applies certified data wiping before devices enter donation channels. device donations works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
        ...
        <section aria-labelledby="community-impact" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          ...
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>Donations support students, nonprofits, and community technology initiatives. device donations works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
        ...
        <section aria-labelledby="business-donations" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          ...
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>Businesses can donate batches of devices and receive sustainability reporting. device donations works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
        ...
        <section aria-labelledby="faq" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          ...
          <dl className="mt-4 grid gap-4 text-slate-700">
              ...
              <div className="rounded-2xl border border-white/60 bg-white/70 p-4">
                <dt className="font-semibold text-slate-900">What devices can be donated?</dt>
                <dd className="mt-2 text-slate-700">Phones, tablets, laptops, and accessories are commonly accepted.</dd>
              </div>

              <div className="rounded-2xl border border-white/60 bg-white/70 p-4">
                <dt className="font-semibold text-slate-900">Is my data removed?</dt>
                <dd className="mt-2 text-slate-700">Yes. All devices are wiped using certified data destruction methods.</dd>
              </div>

              <div className="rounded-2xl border border-white/60 bg-white/70 p-4">
                <dt className="font-semibold text-slate-900">Can businesses donate devices?</dt>
                <dd className="mt-2 text-slate-700">Yes. Corporate donation programs are supported for bulk devices.</dd>
              </div>

              <div className="rounded-2xl border border-white/60 bg-white/70 p-4">
                <dt className="font-semibold text-slate-900">How are donation recipients chosen?</dt>
                <dd className="mt-2 text-slate-700">Devices are matched with education programs and nonprofit partners.</dd>
              </div>

              <div className="rounded-2xl border border-white/60 bg-white/70 p-4">
                <dt className="font-semibold text-slate-900">Do donors get confirmation?</dt>
                <dd className="mt-2 text-slate-700">TechJoy provides confirmation and donation credits where applicable.</dd>
              </div>
          </dl>
        </section>
        ...
        <section aria-labelledby="cta" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          <h2 id="cta" className="text-2xl font-semibold text-slate-900">Donate Devices with TechJoy</h2>
          <p className="mt-3 text-slate-700">Support digital access by donating devices that still have life left.</p>
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            <Link href="/contact" className="rounded-full border border-slate-300 px-4 py-2 text-sm text-slate-700 hover:bg-white">Contact TechJoy</Link>
          </div>
        </section>
