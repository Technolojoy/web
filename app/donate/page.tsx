...
export default function Page() {
  ...
  return (
    <main className="prose mx-auto max-w-4xl p-6">
      <h1>Donate Devices to Reduce the Digital Divide</h1>
      
        <section aria-labelledby="overview">
          <h2 id="overview">Why Donate Electronics</h2>
        ...
        <section aria-labelledby="how-donations-work">
          <h2 id="how-donations-work">How Device Donations Work</h2>
        ...
        <section aria-labelledby="eligible-devices">
          <h2 id="eligible-devices">Devices You Can Donate</h2>
        ...
        <section aria-labelledby="data-security">
          <h2 id="data-security">Secure Data Handling</h2>
        ...
        <section aria-labelledby="community-impact">
        ...
        <section aria-labelledby="business-donations">
          <h2 id="business-donations">Corporate Donation Programs</h2>
