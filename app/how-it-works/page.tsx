  ...
  return (
    <main className="section grid gap-6">
      <header className="rounded-3xl border border-white/70 bg-white/85 p-8 shadow-glow">
        <h1 className="text-4xl font-semibold tracking-tight text-slate-900 md:text-5xl">How TechJoy Works - Sell, Recycle, or Donate Electronics in Minutes</h1>
        <p className="mt-4 max-w-3xl text-lg text-slate-700">Learn how TechJoy makes it easy to sell used devices, recycle electronics responsibly, or donate phones and laptops to people in need.</p>
      </header>
      
        <section aria-labelledby="overview" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          <h2 id="overview" className="text-2xl font-semibold text-slate-900">Introduction to the TechJoy Process</h2>
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>TechJoy is a platform designed to make electronics recycling, resale, and donation simple and rewarding. Millions of devices sit unused in homes around the world, contributing to electronic waste and environmental damage. device recycling and resale works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
        ...
        <section aria-labelledby="step-1" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          <h2 id="step-1" className="text-2xl font-semibold text-slate-900">Step 1 - Find Your Device</h2>
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>Users start by selecting the device they want to sell, recycle, or donate. TechJoy supports smartphones, tablets, laptops, gaming consoles, and accessories. device recycling and resale works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
            <p>Device categories are structured so users can identify their model quickly and receive an instant evaluation.</p>
          </div>
        </section>

        <section aria-labelledby="step-2" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          <h2 id="step-2" className="text-2xl font-semibold text-slate-900">Step 2 - Get an Instant Value</h2>
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>TechJoy's pricing engine evaluates device condition and market demand to provide instant value estimates. device recycling and resale works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
        ...
        <section aria-labelledby="step-3" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          <h2 id="step-3" className="text-2xl font-semibold text-slate-900">Step 3 - Ship Your Device</h2>
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>TechJoy provides free shipping labels or pickup options. Packaging instructions ensure devices arrive safely. device recycling and resale works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
            <p>Clear shipping steps help reduce damage in transit and keep processing timelines predictable.</p>
          </div>
        </section>

        <section aria-labelledby="step-4" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          <h2 id="step-4" className="text-2xl font-semibold text-slate-900">Step 4 - Secure Data Wipe</h2>
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>Every device goes through certified data wiping procedures to ensure personal data is permanently removed. device recycling and resale works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
            <p>Security standards follow modern data destruction guidelines used by major IT asset disposal providers.</p>
          </div>
        </section>

        <section aria-labelledby="step-5" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          <h2 id="step-5" className="text-2xl font-semibold text-slate-900">Step 5 - Reuse, Refurbish, or Recycle</h2>
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>Devices received by TechJoy enter one of three pathways: refurbishment for resale, donation to digital access programs, or responsible recycling of components. device recycling and resale works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
            <p>This circular model helps extend device life and reduce electronic waste.</p>
          </div>
        </section>

        <section aria-labelledby="why-it-matters" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          <h2 id="why-it-matters" className="text-2xl font-semibold text-slate-900">Why TechJoy Matters</h2>
          <div className="mt-4 grid gap-4 text-base leading-relaxed text-slate-700">
            <p>Electronic waste is one of the fastest-growing waste streams in the world. Millions of devices are discarded every year, often ending up in landfills. device recycling and resale works best when guidance is clear, timelines are visible, and expectations are consistent.</p>
        ...
        <section aria-labelledby="faq" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          ...
          <dl className="mt-4 grid gap-4 text-slate-700">
              ...
              <div className="rounded-2xl border border-white/60 bg-white/70 p-4">
                <dt className="font-semibold text-slate-900">What devices can I send to TechJoy?</dt>
                <dd className="mt-2 text-slate-700">TechJoy accepts smartphones, tablets, laptops, gaming consoles, and accessories across common brands.</dd>
              </div>

              <div className="rounded-2xl border border-white/60 bg-white/70 p-4">
                <dt className="font-semibold text-slate-900">How long does the process take?</dt>
                <dd className="mt-2 text-slate-700">Most devices are processed within a few business days once received, with status updates along the way.</dd>
              </div>

              <div className="rounded-2xl border border-white/60 bg-white/70 p-4">
                <dt className="font-semibold text-slate-900">Is my data erased securely?</dt>
                <dd className="mt-2 text-slate-700">Yes. Devices are processed with certified data wiping procedures that permanently remove personal data.</dd>
              </div>

              <div className="rounded-2xl border border-white/60 bg-white/70 p-4">
                <dt className="font-semibold text-slate-900">How do I receive payment?</dt>
                <dd className="mt-2 text-slate-700">You can choose cash payout, reward points, or donation credits depending on device eligibility.</dd>
              </div>

              <div className="rounded-2xl border border-white/60 bg-white/70 p-4">
                <dt className="font-semibold text-slate-900">What happens to devices that cannot be reused?</dt>
                <dd className="mt-2 text-slate-700">Devices with no resale value are responsibly recycled with material recovery.</dd>
              </div>
          </dl>
        </section>
        ...
        <section aria-labelledby="cta" className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow">
          <h2 id="cta" className="text-2xl font-semibold text-slate-900">Start Your TechJoy Journey</h2>
          <p className="mt-3 text-slate-700">Ready to recycle, sell, or donate your devices? Choose the path that fits your goal.</p>
